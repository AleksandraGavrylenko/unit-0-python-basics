...
your_name = "Sasha"  # TODO: Change this to your actual name
...
grade = 10
print('Hello '+ name)
# print('I am in grade '+10)  cant concat str+int
...
# Python: 
print(f'Hello {name}')
print(f'{name} will be in grade {grade+1} nxt yr')
